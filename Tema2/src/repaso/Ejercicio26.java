...
public class Ejercicio26 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			// mensaje indicando... y se quedará esperando a que el usuario indique una de
			// las tres
			...
			else if (eleccionUsuario.equals("piedra") && maquina.equals("tijera")
					|| eleccionUsuario.equals("papel") && maquina.equals("piedra")
					|| eleccionUsuario.equals("tijera") && maquina.equals("papel")) {
